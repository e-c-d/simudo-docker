...
# 2. cd /home/user/dolfin/bld/ && make -j4 && make install
...
# Decrease this if you run out of RAM. For example, at build time: --build-arg MAKE_J=4
ARG MAKE_J=16
